...
if ( ! function_exists ( 'register_skt_donation_settings' ) ) {
	function register_skt_donation_settings() {
		...
		/*******For 2Checkout Api Setting*******/
		register_setting('skt-donations-settings-group','skt_donation_twocheck_active_dactive');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_mode_zero_one');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_sellerid_one');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_username');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_password');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_test_publish_key');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_test_private_key');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_live_publish_key');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_live_private_key');
		...
		// For 2Chectout form setting
		register_setting('skt-donations-settings-group','skt_donation_twocheck_address');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_city');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_state');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_zipcode');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_country');
		// For 2Chectout form label setting
		register_setting('skt-donations-settings-group','skt_donation_twocheck_address_label');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_city_label');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_state_label');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_zipcode_label');
		register_setting('skt-donations-settings-group','skt_donation_twocheck_country_label');
	}
}
?>