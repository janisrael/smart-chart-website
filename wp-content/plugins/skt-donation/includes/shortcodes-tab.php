...
<div id="skt-donations-tab-4" class="skt-donations-tab-content <?php if ( esc_attr(get_option('skt_donation_active_tab') == 'tab4' ) ) { ?> skt-donations-current <?php } ?>">
	...
	<div class="skt_donation_two_check_extra_field">
		<h3><?php esc_attr_e('Placeholder Setting For 2Checkout','skt-donation');?></h3>
		<label><?php esc_attr_e('Address','skt-donation');?></label>
		<input type="text" name="skt_donation_twocheck_address" value="<?php echo esc_attr( get_option('skt_donation_twocheck_address') ); ?>">
		<label><?php esc_attr_e('City','skt-donation');?></label>
		<input type="text" name="skt_donation_twocheck_city" value="<?php echo esc_attr( get_option('skt_donation_twocheck_city') ); ?>">
		<label><?php esc_attr_e('State','skt-donation');?></label>
		<input type="text" name="skt_donation_twocheck_state" value="<?php echo esc_attr( get_option('skt_donation_twocheck_state') ); ?>">
		<label><?php esc_attr_e('ZipCode','skt-donation');?></label>
		<input type="text" name="skt_donation_twocheck_zipcode" value="<?php echo esc_attr( get_option('skt_donation_twocheck_zipcode') ); ?>">
		<label><?php esc_attr_e('Country','skt-donation');?></label>
		<input type="text" name="skt_donation_twocheck_country" value="<?php echo esc_attr( get_option('skt_donation_twocheck_country') ); ?>">
	</div>
	<div class="skt_donation_two_check_extra_field">
		<h3><?php esc_attr_e('Label Setting For 2Checkout','skt-donation');?></h3>
		<label><?php esc_attr_e('Address','skt-donation');?></label>
		<input type="text" name="skt_donation_twocheck_address_label" value="<?php echo esc_attr( get_option('skt_donation_twocheck_address_label') ); ?>">
		<label><?php esc_attr_e('City','skt-donation');?></label>
		<input type="text" name="skt_donation_twocheck_city_label" value="<?php echo esc_attr( get_option('skt_donation_twocheck_city_label') ); ?>">
		<label><?php esc_attr_e('State','skt-donation');?></label>
		<input type="text" name="skt_donation_twocheck_state_label" value="<?php echo esc_attr( get_option('skt_donation_twocheck_state_label') ); ?>">
		<label><?php esc_attr_e('ZipCode','skt-donation');?></label>
		<input type="text" name="skt_donation_twocheck_zipcode_label" value="<?php echo esc_attr( get_option('skt_donation_twocheck_zipcode_label') ); ?>">
		<label><?php esc_attr_e('Country','skt-donation');?></label>
		<input type="text" name="skt_donation_twocheck_country_label" value="<?php echo esc_attr( get_option('skt_donation_twocheck_country_label') ); ?>">
	</div>
