<?php
/**
 * The MAIN FUNCTIONS FILE for SKT Charity Lite
 *
...
function complete_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'SKT Donation - Charity and Fundraising Plugin',
			'slug'      => 'skt-donation',
			'required'  => false,
		),
		array(
			'name'      => 'SKT Templates – Elementor prebuilt templates',
			'slug'      => 'skt-templates',
			'required'  => false,
		)		
	);
...
function skt_complete_import_files() {
	return array(
		array(
			'import_file_name'             => 'Import SKT Charity Lite Demo',
